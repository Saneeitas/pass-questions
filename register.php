...
<div class="d-flex aligns-items-center justify-content-center py-3">
    <form action="" method="post">
     ...
     <div class="input-group flex-nowrap my-3">
       <span class="input-group-text " style="background-color:#3b7fad;"><i class="fas fa-envelope"></i></span>
     ...
     <button type="submit" name="register" class="btn btn-sm my-3 form-control" style="background-color:#3b7fad;"><i class="fas fa-sign-in-alt"></i> REGISTER</button>
     <br>
